...
from lperforce import loginP4,P4Lib
...
for DepotFile in changeDepotFile:
    ...
    is_success=clean_file.clean_file(localPath)
    if is_success:
        need_clean_files.append(localPath)
if need_clean_files:
    P4Lib.submitChange(need_clean_files,
                    description=f'清理Maya文件')
